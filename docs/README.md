...
- **[Managers](managers.md)**: Deep dive into the specialized logic for Grades, Attendance, and more.
...
## Need Help?
If you're looking for general usage examples, check the main `README.md` in the root directory or take a look at `example_usage.py`.
